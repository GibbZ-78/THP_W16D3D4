const myProjectTab = [
  ...
  },
  {
    ...
    long_descr: "Malgré nos conseils et notre site web créé sur Wix, Sedal semble ne pas vouloir décoller.\n\n Et pour cause : Sedal produit et commercialise des fixations et ancrage d'une grande solidité, empêchant tout ouvrage d'être arraché et/ou emporté par le vent !"
  },
  {
    id: "4",
    customer: "AnJoVal",
    name: "La petite agence qui monte, qui monte...",
    short_descr: "Pour le coup, c'est une de nos plus belles réussites",
    long_descr: "Rien à rajouter, nous avons juste été géniaux et avons permis à la société AnJoVal de conquérir le secteur immobilier orléanais : CQFD !"
  },
];
